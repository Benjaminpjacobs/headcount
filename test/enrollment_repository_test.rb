...
class EnrollmentRepositoryTest < Minitest::Test
  ...
  #   expected = [:kindergarten_participation, "COLORADO", {
  ...
  def test_enrollment_can_load_more_than_one_study
    er = EnrollmentRepository.new
    er.load_data({ :enrollment => {:kindergarten_participation => "./data/Kindergartners in full-day program.csv", :high_school_graduation => './data/High school graduation rates.csv', :pupil_enrollment => "./data/Pupil enrollment.csv", :special_education => "./data/Special education.csv"}})
