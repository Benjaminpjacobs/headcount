...
class HeadcountAnalystTest < Minitest::Test
  ...
  def setup
    ...
    #   actual = @hc.kindergarten_participation_against_household_income_per_district("ACADEMY 20")
    #   expected = 0.766
    #   assert_equal expected, actual
    # end

    # def test_kind_part_correlates_with_house_income
    #   assert @hc.kindergarten_participation_correlates_with_household_income(for: "ACADEMY 20")
    ...
    #   refute @hc.kindergarten_participation_correlates_with_household_income(for: "DENVER COUNTY 1")
    # end
